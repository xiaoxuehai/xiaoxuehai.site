    ...
    >
      <div className='absolute inset-0 overflow-visible [container-type:size]'>
        <div className='absolute inset-0 h-[100cqh] animate-slide transition-opacity [aspect-ratio:1] [border-radius:0] [mask:none] group-hover:opacity-100'>
          <div className='absolute -inset-full w-auto rotate-0 animate-spin-linear [background:conic-gradient(from_calc(270deg-(var(--spread)*0.5)),transparent_0,hsl(0_0%_100%/1)_var(--spread),transparent_var(--spread))] [translate:0_0]' />
        </div>
      </div>
